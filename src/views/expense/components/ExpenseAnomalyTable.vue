...
<style scoped>
.expense-anomaly-table { display:grid; grid-template-rows:auto minmax(0,1fr) auto; min-width:0; height:100%; min-height:0; border:1px solid #dfe5ec; background:#fff; }
.table-head { display:flex; min-height:38px; align-items:center; justify-content:space-between; gap:10px; padding:0 10px; border-bottom:1px solid #e5e9ef; }
.result-tabs { display:flex; min-width:0; gap:18px; overflow-x:auto; scrollbar-width:none; }
.result-tabs button { position:relative; height:38px; flex:0 0 auto; border:0; background:transparent; color:#303846; font-size:12px; font-weight:600; }
...
th, td { height:30px; overflow:hidden; border-bottom:1px solid #edf0f4; padding:0 6px; text-align:left; text-overflow:ellipsis; white-space:nowrap; }
.col-id { width:120px; }
...
.risk-tag { display:inline-flex; min-width:40px; justify-content:center; border-radius:4px; padding:1px 5px; font-size:11px; }
...
.row-actions button { border:0; padding:0; background:transparent; color:var(--color-info); font-size:11px; }
.row-actions button:disabled { cursor:not-allowed; color:#a9b4c2; }
.empty-state { height:120px; text-align:center; color:#7a8491; }
.pagination { display:flex; min-height:38px; align-items:center; justify-content:flex-end; gap:8px; padding:0 10px; color:#4b5563; font-size:12px; }
.pagination .total { margin-right:auto; }
.page-buttons { display:inline-flex; align-items:center; gap:4px; }
