<template>
  <div class="expense-audit-overview-page">
    <section class="overview-main">
      <header class="overview-title-row">
        <h1>费用审计分析</h1>
      </header>
...
@media(max-width:720px){.overview-title-row{align-items:flex-start;flex-direction:column;gap:8px}.filter-panel,.metric-grid{grid-template-columns:1fr}.metric-card{border-right:0;border-bottom:1px solid var(--audit-line)}.donut-layout{grid-template-columns:1fr}.chart-card{height:auto;min-height:260px}.table-footer{align-items:flex-start;flex-direction:column;gap:10px}.detail-drawer dl div{grid-template-columns:68px minmax(0,1fr)}}
</style>
