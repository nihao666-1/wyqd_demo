...
<style scoped>
.dialog-layer{position:fixed;z-index:100;inset:0;display:grid;place-items:center;background:rgb(17 24 39 / 30%)}.action-dialog{width:420px;padding:0 18px 16px;border:1px solid #dce2e9;border-radius:5px;background:#fff;box-shadow:0 14px 34px rgb(20 30 45 / 20%)}.action-dialog header{display:flex;height:48px;align-items:center;justify-content:space-between;border-bottom:1px solid #e8ebef}.action-dialog h2{font-size:16px}.action-dialog header button{border:0;background:transparent;font-size:22px}.action-dialog>p{margin:12px 0 0;color:#697586;font-size:12px}.action-dialog>label{display:block;margin:13px 0 6px;font-size:12px;font-weight:600}.action-dialog textarea{width:100%;height:92px;resize:none;padding:9px;border:1px solid #ccd4df;border-radius:4px;font:12px/20px inherit}.dialog-error{display:block;margin-top:5px;color:var(--color-primary);font-size:11px}.action-dialog footer{display:flex;justify-content:flex-end;gap:10px;margin-top:14px}.action-dialog footer button{height:32px;padding:0 18px;border:1px solid #d1d8e2;border-radius:4px;background:#fff}.action-dialog footer button.primary{border-color:var(--color-primary);background:var(--color-primary);color:#fff}.trail-dialog{width:720px}.trail-head,.trail-list article{display:grid;grid-template-columns:90px 80px minmax(170px,1fr) 110px 130px;gap:8px;align-items:center}.trail-head{padding:10px 8px;background:#f7f8fa;color:#626d7b;font-size:11px}.trail-list{max-height:360px;overflow:auto}.trail-list article{min-height:46px;padding:7px 8px;border-bottom:1px solid #edf0f4;font-size:10px}.trail-list article strong{color:#25303d}.trail-list article span,.trail-list article time{color:#667181}.trail-list article p{margin:0;line-height:15px;overflow-wrap:anywhere}
</style>
