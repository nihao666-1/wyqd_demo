...
.generation-workspace{height:auto;min-height:628px;grid-template-rows:309px minmax(309px,1fr)}
.draft-row{grid-template-columns:minmax(0,3fr) minmax(184px,1fr);min-height:0}
.standard-table-panel{grid-template-rows:33px minmax(242px,1fr) 33px}
