...
.condition-field > span.required::before {
  content: "*";
  margin-right: 3px;
...
.condition-field select {
  ...
  background: #fff;
  color: #323844;
  font: 400 12px/28px inherit;
  white-space: nowrap;
  text-overflow: ellipsis;
}

.condition-field select:focus-visible {
