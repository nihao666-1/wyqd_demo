...
<style scoped>
.report-generation-page{position:relative;width:min(100%,1378px);max-width:1378px;margin:0 auto;padding:14px 8px 14px;color:#172033;font-size:12px}.report-titlebar{height:40px;display:flex;align-items:center;justify-content:space-between;padding:0 9px;border:1px solid #ffd7d7;background:#fff}.report-titlebar h2{font-size:21px;line-height:1;font-weight:800}.title-actions{display:flex;align-items:center;gap:8px}.title-actions button,.source-tools button,.source-card footer button,.chapter-actions button,.progress-metrics button,.outline-action{height:30px;padding:0 14px;border:1px solid #d4dbe5;border-radius:4px;background:#fff;color:#1f2937;font-size:12px;font-weight:700}.title-actions .danger{border-color:#c7000b;background:#c7000b;color:#fff}.title-actions .export{min-width:107px;justify-content:center;display:inline-flex;gap:8px}.task-meta-strip{height:58px;margin:8px 335px 10px 9px;display:grid;grid-template-columns:106px 252px 178px 190px 104px 1fr;border:1px solid #e2e6ec;background:#fff}.task-meta-strip div{min-width:0;padding:9px 13px;border-right:1px solid #e2e6ec}.task-meta-strip div:last-child{border-right:0}.task-meta-strip span{display:block;margin-bottom:8px;color:#556070;font-size:11px;font-weight:700}.task-meta-strip strong{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px}.task-meta-strip .status-text{display:inline-flex;height:20px;align-items:center;padding:0 7px;border-radius:3px;background:#fff0df;color:#e56f00}
.report-generation-grid{display:grid;grid-template-columns:204px minmax(640px,790px) 326px;gap:12px;align-items:start}.generation-config,.progress-card,.editor-card,.source-rail,.output-panel,.version-panel,.export-history-panel{border:1px solid #e2e7ef;border-radius:4px;background:#fff}.generation-config{height:654px;padding:12px 10px;display:flex;flex-direction:column;gap:11px}.generation-config h3,.progress-card h3,.chapter-list h3,.chapter-actions h3,.source-rail h3,.output-panel h3,.version-panel h3,.export-history-panel h3{font-size:13px;font-weight:800}.generation-config label{display:grid;gap:6px;color:#303848;font-size:12px;font-weight:700}.generation-config label>span::before{content:"• ";color:#d10000}.generation-config select{width:100%;height:32px;border:1px solid #d8dee8;border-radius:4px;background:#fbfcfe;color:#344054;font-size:12px}.outline-action{align-self:center;width:118px}.format-checks{display:grid;grid-template-columns:1fr 1fr;gap:8px 9px}.format-checks>span{grid-column:1/-1;font-weight:800}.format-checks label{display:flex;align-items:center;gap:6px;font-weight:700}.format-checks input{accent-color:#c7000b}.switch-row{display:flex;align-items:center;justify-content:space-between}.switch-row span{font-weight:800}.switch-row button{position:relative;width:40px;height:20px;border:0;border-radius:99px;background:#c7000b;color:#fff;font-size:0}.switch-row button::after{content:"";position:absolute;right:3px;top:3px;width:14px;height:14px;border-radius:50%;background:#fff}.start-button{height:34px;margin-top:5px;border:0;border-radius:4px;background:#c50000;color:#fff;font-weight:800}.hint-title{margin-top:10px;font-weight:800}.hint-text{color:#667085;font-size:11px;line-height:1.8}
.generation-center{display:grid;gap:12px}.progress-card{height:334px;padding:18px 12px 10px}.step-flow{list-style:none;margin:0;padding:0 10px 15px;display:grid;grid-template-columns:repeat(6,1fr);position:relative}.step-flow::before{content:"";position:absolute;left:43px;right:43px;top:12px;height:2px;background:#d9dee8}.step-flow li{position:relative;z-index:1;display:grid;justify-items:center;gap:5px;color:#6b7280}.step-dot{width:23px;height:23px;border-radius:50%;display:grid;place-items:center;background:#9aa3b2;color:#fff;font-size:12px;font-weight:800}.step-flow li.done .step-dot{background:#0aa36c}.step-flow li.active .step-dot{background:#d50000}.step-flow li strong{font-size:12px;color:#1f2937}.step-flow li em{height:20px;padding:2px 8px;border-radius:3px;background:#f3f5f8;font-style:normal;font-size:11px}.step-flow li.done em{background:#e8f8ef;color:#0b8f5a}.step-flow li.active em{background:#fff0f0;color:#d50000}.progress-body{display:grid;grid-template-columns:minmax(0,1fr) 405px;gap:24px}.generation-logs{list-style:none;margin:12px 0 0;padding:0;display:grid;gap:7px}.generation-logs li{display:grid;grid-template-columns:58px 1fr;align-items:center;gap:8px;position:relative;padding-left:12px}.generation-logs li::before{content:"";position:absolute;left:0;top:7px;width:6px;height:6px;border-radius:50%;background:#1e80ff}.generation-logs li.success::before{background:#18a15f}.generation-logs li.active::before{background:#d50000}.generation-logs span{color:#667085}.generation-logs p{line-height:1.25;color:#344054}.progress-metrics{padding-top:27px;display:grid;grid-template-columns:minmax(0,1fr) 40px;gap:11px;align-items:center}.progress-track{height:7px;border-radius:99px;background:#e8ebf1;overflow:hidden}.progress-track span{display:block;height:100%;border-radius:inherit;background:#d50000}.progress-metrics strong{color:#d50000}.progress-metrics dl{grid-column:1/-1;display:grid;grid-template-columns:1fr 1fr;gap:9px 22px;margin:0}.progress-metrics div{display:flex}.progress-metrics dt{color:#667085}.progress-metrics dd{margin:0;color:#344054}.progress-metrics button{justify-self:end;grid-column:2}.readiness-title{margin:12px 0 9px}.readiness-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}.readiness-grid article{height:72px;border:1px solid #e1e7ef;border-radius:6px;background:#fff;display:flex;gap:10px;align-items:center;padding:10px}.source-icon{width:30px;height:30px;border-radius:6px;display:grid;place-items:center;font-size:14px}.readiness-grid .red .source-icon{background:#fff1f1;color:#d50000}.readiness-grid .green .source-icon{background:#eaf8ef;color:#0a9b5b}.readiness-grid .orange .source-icon{background:#fff4e6;color:#f08300}.readiness-grid strong{display:block;margin-bottom:5px}.readiness-grid em{display:inline-flex;height:19px;align-items:center;padding:0 7px;border-radius:3px;background:#eaf8ef;color:#0a9b5b;font-style:normal;font-size:11px}.readiness-grid .orange em{background:#fff4e6;color:#f08300}.readiness-grid p{margin-top:7px;color:#667085;line-height:1}
.editor-card{height:306px;display:grid;grid-template-columns:146px minmax(0,1fr) 126px}.chapter-list{border-right:1px solid #e2e7ef;padding:10px 8px}.chapter-list h3 span{color:#667085;font-weight:700}.chapter-list button{width:100%;height:27px;border:0;border-radius:4px;background:transparent;text-align:left;font-size:11px;font-weight:700;color:#1f2937}.chapter-list button.active{background:#fff0f0;color:#d50000}.chapter-list span{margin-right:5px}.editor-surface{min-width:0}.editor-toolbar{height:34px;border-bottom:1px solid #e2e7ef;display:flex;align-items:center;gap:5px;padding:0 8px}.editor-toolbar button,.editor-toolbar select{height:24px;border:0;background:#fff;color:#344054;font-size:12px}.editor-toolbar select{border:1px solid #dde3eb;border-radius:3px}.doc-paper{height:271px;padding:17px 30px;overflow:hidden}.doc-paper h1{text-align:center;font-size:18px;margin-bottom:16px}.doc-paper h4,.doc-paper h5{margin:0 0 8px;font-size:13px}.doc-paper p{margin:0 0 10px;font-size:12px;line-height:1.75}.ai-paragraph{position:relative;border:1px solid #b9d3ff;border-radius:4px;background:#f4f8ff;padding:8px 45px 8px 34px}.ai-paragraph span{position:absolute;left:8px;top:10px;width:18px;height:18px;border-radius:3px;background:#1f7ae0;color:#fff;display:grid;place-items:center;font-size:10px;font-weight:800}.ai-paragraph button,.issue-tag{height:22px;border:1px solid #ffb3a8;border-radius:4px;background:#fff1ef;color:#d50000;font-size:11px}.ai-paragraph button{position:absolute;right:8px;top:20px}.chapter-actions{border-left:1px solid #e2e7ef;padding:10px 9px;display:grid;align-content:start;gap:8px}.chapter-actions button{width:100%;height:29px;padding:0 6px}.chapter-actions .red-outline{border-color:#ff9f9f;color:#d50000}.chapter-actions dl{margin:9px 0 0;display:grid;gap:6px}.chapter-actions dl div{display:flex;justify-content:space-between}.chapter-actions dt{color:#667085}.chapter-actions dd{margin:0}.danger-count{color:#d50000}
.source-rail{position:absolute;right:14px;top:62px;width:326px;height:778px;display:grid;grid-template-rows:42px 43px 43px minmax(0,1fr) 43px}.source-rail header{display:flex;align-items:center;justify-content:space-between;padding:0 12px}.source-rail header button{border:0;background:#fff;font-size:22px}.source-tabs{display:flex;align-items:end;gap:14px;padding:0 10px;border-bottom:1px solid #e2e7ef;overflow:hidden}.source-tabs button{height:36px;border:0;background:#fff;color:#344054;font-size:12px;font-weight:800;white-space:nowrap}.source-tabs .active{color:#d50000;border-bottom:2px solid #d50000}.source-tools{display:flex;align-items:center;gap:8px;padding:0 10px}.source-tools strong{margin-right:auto}.source-tools select{height:28px;width:84px;border:1px solid #d8dee8;border-radius:4px;background:#fff;font-size:11px}.source-tools button{height:28px;padding:0 9px}.source-list{overflow:auto;padding:0 9px 8px;display:grid;gap:8px;align-content:start}.source-card{min-height:192px;border:1px solid #e1e7ef;border-radius:6px;background:#fff;padding:12px}.source-card>div:first-child{display:flex;align-items:center;gap:8px}.source-index{width:18px;height:18px;border-radius:4px;background:#1f7ae0;color:#fff;display:grid;place-items:center;font-weight:800}.source-card em{height:22px;padding:0 8px;border-radius:4px;background:#eaf3ff;color:#1f7ae0;display:inline-flex;align-items:center;font-style:normal;font-weight:800}.source-card h4{margin:10px 0 7px;font-size:13px}.source-card p{height:42px;overflow:hidden;color:#344054;font-size:12px;line-height:1.7}.source-card dl{display:grid;grid-template-columns:1fr 1fr 45px;margin:6px 0 9px}.source-card dl div{display:flex;gap:3px}.source-card dt{color:#667085}.source-card dd{margin:0}.source-card footer{display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px}.source-card footer button{height:28px;padding:0;border-color:#dbe2ec;font-size:11px}.pager{display:flex;align-items:center;justify-content:center;gap:7px;border-top:1px solid #e2e7ef}.pager button{width:24px;height:24px;border:1px solid #dbe2ec;border-radius:4px;background:#fff}.pager button.active{border-color:#c7000b;background:#c7000b;color:#fff}.pager strong{font-weight:700;color:#344054}
.bottom-row{width:min(100%,1006px);display:grid;grid-template-columns:502px 358px 126px;gap:10px;margin-top:10px;margin-left:0}.output-panel,.version-panel,.export-history-panel{height:122px;padding:9px 10px}.output-panel p{margin:6px 0 8px;color:#344054;font-weight:700;line-height:1}.output-files{display:grid;grid-template-columns:repeat(5,1fr);gap:8px}.output-files article{height:60px;border:1px solid #e2e7ef;border-radius:4px;background:#fff;display:grid;align-content:center;justify-items:start;padding:8px;gap:4px}.output-files span{height:18px;min-width:18px;border-radius:3px;color:#fff;display:inline-grid;place-items:center;font-size:9px;font-weight:800}.output-files .word{background:#2e74d6}.output-files .pdf{background:#d32020}.output-files .zip{background:#f28c00}.output-files .excel{background:#1f9d55}.output-files strong{font-size:11px}.output-files small{color:#667085}.version-panel ol{position:relative;list-style:none;margin:15px 0 0;padding:0;display:grid;grid-template-columns:repeat(4,1fr)}.version-panel ol::before{content:"";position:absolute;left:16px;right:16px;top:7px;border-top:2px dotted #c4ccd8}.version-panel li{position:relative;display:grid;gap:4px}.version-panel li span{width:10px;height:10px;border-radius:50%;background:#8f99a8;z-index:1}.version-panel li.active span{background:#1f7ae0}.version-panel li.current span{background:#c7000b}.version-panel strong{font-size:13px}.version-panel em,.version-panel time{font-style:normal;font-size:11px;color:#344054}.version-panel time{color:#667085}.export-history-panel p{margin-top:34px;color:#667085;text-align:center;line-height:1.4}.report-toast{position:fixed;right:24px;top:68px;z-index:80;padding:9px 14px;border-radius:4px;background:rgba(31,41,55,.94);color:#fff}.reopen-source{position:fixed;right:16px;top:120px;z-index:30;height:34px;border:1px solid #c7000b;border-radius:4px;background:#fff;color:#c7000b;font-weight:800}
@media (max-width:1500px){.report-generation-page{width:1378px;max-width:none;zoom:calc((100vw - 210px) / 1378);margin:0}.report-titlebar,.task-meta-strip,.report-generation-grid,.bottom-row{transform-origin:top left}}
