...
<style scoped>
.archive-sidebar { position: relative; height: 864px; padding: 0 15px 54px; border: 1px solid #e5e8ec; border-radius: 4px; background:#fff; overflow:hidden; color:#252930; }
...
.section-heading { display:flex;align-items:center;justify-content:space-between;gap:4px;margin-bottom:9px; }.section-heading button { padding:0;border:0;background:transparent;color:#1677ff;font-size:9px;white-space:nowrap; }
