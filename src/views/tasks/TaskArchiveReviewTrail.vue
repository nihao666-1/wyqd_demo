...
.archive-timeline li { position: relative; min-width: 0; padding-top: 27px; text-align: center; }.archive-timeline li::before { content:""; position:absolute; top:9px; left:-50%; width:100%; height:2px; background:var(--color-success); }.archive-timeline li:first-child::before { display:none; }.archive-timeline li.archive::before { height:1px; background:repeating-linear-gradient(90deg,#9ba2ad 0 5px,transparent 5px 8px); }
.timeline-node { position:absolute; z-index:1; top:0; left:50%; width:19px; height:19px; border-radius:50%; background:var(--color-success); color:#fff; display:grid; place-items:center; transform:translateX(-50%); font-size:9px; }.archive .timeline-node { top:-7px; width:34px; height:34px; border:1px solid #dce1e7; border-radius:6px; background:#f7f8fa; color:#56606d; font-size:17px; }
