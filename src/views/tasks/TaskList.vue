<template>
  ...
  <section v-else class="task-center-page">
    ...
    <div class="metric-strip" aria-label="任务状态统计">
      ...
      <RouterLink class="create-task-tile" to="/tasks/create" aria-label="创建审计任务">
        <TaskIcon name="create" :size="20" />
        <span>创建审计任务</span>
      </RouterLink>
    </div>
