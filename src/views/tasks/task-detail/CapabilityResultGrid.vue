...
<style scoped>
.results-section{background:#fff;border:1px solid #e5eaf0;border-radius:0}.section-heading{height:34px;display:flex;align-items:center;padding:0 13px}.section-heading h2{margin:0;color:#202631;font-size:13px;line-height:22px;font-weight:600}.section-heading small{color:#667085;font-size:10px;font-weight:400}.ability-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px 12px;padding:0 12px 10px}.ability-card{position:relative;min-width:0;height:103px;padding:9px 10px 7px 78px;border:1px solid #e5eaf0;border-radius:6px;background:#fff;display:grid;grid-template-columns:minmax(0,1fr) auto;grid-template-rows:38px 23px 22px;column-gap:8px}.ability-card.selected{border-color:#ff9c9c;background:#fffdfd}.ability-index{position:absolute;left:4px;top:9px;width:20px;height:20px;border-radius:4px;display:grid;place-items:center;color:#fff;font-size:11px;font-weight:600;background:#1677ff}.ability-icon{position:absolute;left:30px;top:10px;width:36px;height:36px;border-radius:8px;display:grid;place-items:center;background:#eef5ff;color:#1677ff;font-size:18px}.ability-index.tone-1{background:#c30000}.ability-index.tone-2{background:#f97316}.ability-index.tone-3{background:#159447}.ability-index.tone-4{background:#7657ef}.ability-index.tone-5,.ability-index.tone-9{background:#1677df}.ability-index.tone-6{background:#24a895}.ability-index.tone-7{background:#f59e0b}.ability-index.tone-8{background:#f4474d}.ability-icon.tone-1{background:#fff0f0;color:#d30000}.ability-icon.tone-2,.ability-icon.tone-7{background:#fff6e8;color:#f97316}.ability-icon.tone-3{background:#edf8f1;color:#159447}.ability-icon.tone-4{background:#f3efff;color:#7657ef}.ability-icon.tone-6{background:#eaf9f7;color:#149b88}.ability-icon.tone-8{background:#fff0f0;color:#f4474d}.ability-copy{min-width:0}.ability-copy h3{margin:0;overflow:hidden;color:#202631;font-size:13px;line-height:20px;font-weight:600;text-overflow:ellipsis;white-space:nowrap}.ability-copy p{margin:3px 0 0;color:#667085;font-size:10px;line-height:16px;white-space:nowrap}.ability-copy strong{color:#303642;font-weight:500}.status-tag{height:18px;padding:0 5px;border:1px solid;border-radius:3px;font-size:9px;line-height:16px;white-space:nowrap}.status-tag.confirmed,.status-tag.check_passed{border-color:#bce7c8;background:#ebf8ef;color:#249b57}.status-tag.pending{border-color:#ffd8a8;background:#fff6e8;color:#fa8c16}.status-tag.awaiting_upload,.status-tag.checking{border-color:#b8d7ff;background:#eef5ff;color:#1677ff}.status-tag.excluded{border-color:#d8dee8;background:#f5f6f8;color:#667085}.ability-file{grid-column:1/2;display:flex;align-items:center;gap:6px;min-width:0;color:#758096;font-size:10px}.ability-file span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.card-actions{grid-column:2/3;grid-row:2/4;display:grid;grid-template-columns:repeat(2,auto);align-content:center;justify-content:end;gap:3px 14px}.card-actions button{padding:0;border:0;background:transparent;color:#1677ff;font-size:10px;line-height:17px}.report-actions{grid-template-columns:auto}
