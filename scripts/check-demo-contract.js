...
const requiredFiles = [
  ...
  'src/views/system/SystemManagement.vue',
...
assert(layoutText.includes('审计知识库'), '左侧菜单缺少审计知识库分组');
assert(layoutText.includes('系统管理') && !layoutText.includes("label: '配置中心'") && !layoutText.includes("label: '记录中心'"), '左侧菜单应将配置与记录合并为系统管理');
